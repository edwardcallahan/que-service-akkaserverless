...
final case class JwtFieldOptions(
    claim: com.akkaserverless.JwtFieldOptions.JwtClaimInclude = com.akkaserverless.JwtFieldOptions.JwtClaimInclude.UNSPECIFIED,
    ...
    def withClaim(__v: com.akkaserverless.JwtFieldOptions.JwtClaimInclude): JwtFieldOptions = copy(claim = __v)
    ...
    def withIssuer(__v: _root_.scala.Predef.String): JwtFieldOptions = copy(issuer = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 6 => _root_.scalapb.descriptors.PString(issuer)
        case 7 => _root_.scalapb.descriptors.PLong(expiresSeconds)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: com.akkaserverless.JwtFieldOptions.type = com.akkaserverless.JwtFieldOptions
    // @@protoc_insertion_point(GeneratedMessage[akkaserverless.JwtFieldOptions])
}

object JwtFieldOptions extends scalapb.GeneratedMessageCompanion[com.akkaserverless.JwtFieldOptions] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.akkaserverless.JwtFieldOptions] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.akkaserverless.JwtFieldOptions = {
    var __claim: com.akkaserverless.JwtFieldOptions.JwtClaimInclude = com.akkaserverless.JwtFieldOptions.JwtClaimInclude.UNSPECIFIED
    ...
    while (!_done__) {
      ...
      _tag__ match {
        case 0 => _done__ = true
        case 8 =>
          __claim = com.akkaserverless.JwtFieldOptions.JwtClaimInclude.fromValue(_input__.readEnum())
        case 18 =>
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.akkaserverless.JwtFieldOptions] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      _root_.scala.Predef.require(__fieldsMap.keys.forall(_.containingMessage eq scalaDescriptor), "FieldDescriptor does not match message type.")
      com.akkaserverless.JwtFieldOptions(
        claim = com.akkaserverless.JwtFieldOptions.JwtClaimInclude.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(1).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(com.akkaserverless.JwtFieldOptions.JwtClaimInclude.UNSPECIFIED.scalaValueDescriptor).number),
        ...
        issuer = __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 1 => com.akkaserverless.JwtFieldOptions.JwtClaimInclude
    }
  }
  lazy val defaultInstance = com.akkaserverless.JwtFieldOptions(
    claim = com.akkaserverless.JwtFieldOptions.JwtClaimInclude.UNSPECIFIED,
    name = "",
    token = false,
  ...
  sealed abstract class JwtClaimInclude(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
    ...
    def companion: _root_.scalapb.GeneratedEnumCompanion[JwtClaimInclude] = com.akkaserverless.JwtFieldOptions.JwtClaimInclude
    final def asRecognized: _root_.scala.Option[com.akkaserverless.JwtFieldOptions.JwtClaimInclude.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[com.akkaserverless.JwtFieldOptions.JwtClaimInclude.Recognized])
  }
  ...
  object JwtClaimInclude extends _root_.scalapb.GeneratedEnumCompanion[JwtClaimInclude] {
    ...
    def javaDescriptor: _root_.com.google.protobuf.Descriptors.EnumDescriptor = com.akkaserverless.JwtFieldOptions.javaDescriptor.getEnumTypes().get(0)
    def scalaDescriptor: _root_.scalapb.descriptors.EnumDescriptor = com.akkaserverless.JwtFieldOptions.scalaDescriptor.enums(0)
  }
  implicit class JwtFieldOptionsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.akkaserverless.JwtFieldOptions]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.akkaserverless.JwtFieldOptions](_l) {
    def claim: _root_.scalapb.lenses.Lens[UpperPB, com.akkaserverless.JwtFieldOptions.JwtClaimInclude] = field(_.claim)((c_, f_) => c_.copy(claim = f_))
  ...
  def of(
    claim: com.akkaserverless.JwtFieldOptions.JwtClaimInclude,
    name: _root_.scala.Predef.String,
  ...
  ): _root_.com.akkaserverless.JwtFieldOptions = _root_.com.akkaserverless.JwtFieldOptions(
    claim,
    name,
    token,
    includeParentClaims,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[akkaserverless.JwtFieldOptions])
}
